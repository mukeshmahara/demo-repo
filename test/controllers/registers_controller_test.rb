...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { age: @register.age, email: @register.email, password: @register.password, username: @register.username } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { age: @register.age, email: @register.email, password: @register.password, username: @register.username } }
